...
export const seedUsers = [
  { email: "admin@teammillimeter.com", password: "1234", name: "관리자", role: "admin" },
  { email: "sales@teammillimeter.com", password: "1234", name: "매출담당", role: "staff" },
  { email: "finance@teammillimeter.com", password: "1234", name: "경리", role: "staff" },
];
