...
function buildErpApiResponse(state, workersOverride = null, workerMonthlyPaymentMemosOverride = null) {
  ...
  return {
    ...
    officePayrollSettings: data.officePayrollSettings || null,
    officePayrollProfiles: Array.isArray(data.officePayrollProfiles) ? data.officePayrollProfiles : [],
    officePayrollSheets: Array.isArray(data.officePayrollSheets) ? data.officePayrollSheets : [],
