...
const outPath = path.join(__dirname, "..", "src", "components", "NotificationSettingsPage.tsx");

const content = String.raw`import React, { useCallback, useEffect, useMemo, useState } from "react";
