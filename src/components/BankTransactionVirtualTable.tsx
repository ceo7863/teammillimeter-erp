...
export function BankTransactionVirtualTable({
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    estimateSize: () => BANK_TABLE_ROW_ESTIMATE_PX,
    overscan: BANK_TABLE_OVERSCAN,
  });
  ...
  return (
    <div
      ref={scrollRef}
      className="erp-bank-table-scroll max-h-[min(72vh,960px)] overflow-auto overscroll-contain [contain:strict]"
    >
...
export function BankTransactionVirtualMobileList({
  ...
  return (
    <div
      ref={scrollRef}
      className="erp-mobile-card-list erp-bank-mobile-scroll max-h-[min(72vh,960px)] space-y-3 overflow-auto overscroll-contain md:hidden [contain:strict]"
    >
